...
window.onload = function () {
	...
	document.getElementById('info-btn').addEventListener('click', function(){
		console.log('od-pc-layout-two-columns', document.getElementsByClassName('od-pc-layout-two-columns')[0])
	})

	chrome.runtime.sendMessage({greeting: "crawInfo"}, function(response) {
